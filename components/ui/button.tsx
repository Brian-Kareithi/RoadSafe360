...
const buttonVariants = cva('inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-400 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0', {
  variants: {
    variant: {
      ...
      destructive: 'bg-red-600 text-zinc-50 shadow-sm hover:bg-red-500 dark:bg-red-900 dark:text-zinc-50 dark:hover:bg-red-800',
      ...
      kenyan: 'bg-[#BB2020] text-white shadow hover:bg-[#8B0000] dark:bg-[#CC3333] dark:hover:bg-[#990000]',
    },
    size: {
